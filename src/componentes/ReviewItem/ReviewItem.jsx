    ...
    return (
        <div className='mb-10 w-full border-2 border-[#95A0A7] h-28 flex'>
            ...
            <div className='w-full px-4 flex justify-between items-center   '>
                ...
                <button onClick={()=>handelRemoveCart(_id)} className='mr-0 text-[#cb2c2c] text-2xl bg-[#da42424c] rounded-full h-10 w-10 opacity-60 flex justify-center items-center '><AiOutlineDelete></AiOutlineDelete> </button>
            </div>
        </div>
    );
};
